...
import { AppError, ErrorResponse, getErrorMessage, SuccessResponse, TrendingHashtagType } from 'tweetly-shared';
...
export async function GET(req: NextRequest) {
    if (req.method === 'GET') {
        ...
        try {
            ...
            else if (!data.hashtags) throw new AppError('Hashtags property is missing in data response', 404, 'MISSING_PROPERTY');
