...
import { AppError, ErrorResponse, getErrorMessage, isZodError, SuccessResponse, userUpdateBirthdaySchema } from 'tweetly-shared';
import { z } from "zod";
...
export async function PATCH(req: NextRequest) {
    if (req.method === 'PATCH') {
        ...
        try {
            ...
            const body = await req.json() as z.infer<typeof userUpdateBirthdaySchema>;
            const validatedData = userUpdateBirthdaySchema.parse(body);
