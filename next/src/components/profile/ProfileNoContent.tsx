...
import { Rss, Reply, Image as Media, Heart } from 'lucide-react';

export default function ProfileNoContent({ type, authorized }: { type: 'POSTS' | 'REPLIES' | 'MEDIA' | 'LIKES', authorized: boolean }) {
    return (
