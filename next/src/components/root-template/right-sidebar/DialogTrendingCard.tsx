...
export default function DialogTrendingCard({ hashtag }: { hashtag: TrendingHashtagType }) {
    ...
    return (
        <Link href={`http://localhost:3000/search?q=${hashtag.name}`} className='p-2 rounded flex flex-col text-14 text-gray-500 hover:bg-card-hover hover:cursor-pointer'>
            <p>Trending</p>
