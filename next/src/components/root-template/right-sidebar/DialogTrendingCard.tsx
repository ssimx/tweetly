...
export default function DialogTrendingCard({ hashtag }: { hashtag: TrendingHashtagType }) {
    ...
    return (
        <Link href={`http://192.168.1.155:3000/search?q=${hashtag.name}`} className='px-4 py-6 rounded flex items-center gap-8 text-14 text-secondary-text hover:bg-post-hover hover:cursor-pointer'>
